...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void nameList() {
        ...
        /**
         * Create a list of customer names by using {@link java.util.stream.Stream#collect} and {@link Collectors#toList}
         */
    ...
    public void ageSet() {
        ...
        /**
         * Create a set of customer age by using {@link java.util.stream.Stream#collect} and {@link Collectors#toSet}
         */
    ...
    public void oldestCustomer() {
         ...
         */
        Comparator<Customer> comparatorByAge = Comparator.comparingInt(Customer::getAge);
        Optional<Customer> oldestCustomer = customerList.stream()
                .collect(Collectors.maxBy(comparatorByAge));
